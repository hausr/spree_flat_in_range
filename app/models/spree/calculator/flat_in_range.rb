module Spree
  class Calculator::FlatInRange < Calculator
    ...
    preference :default_amount,   :decimal, :default => 0.0
    attr_accessible :preferred_lower_boundry, :preferred_upper_boundry, :preferred_amount, :preferred_default_amount
    ...
    def compute(object)
      ...
      if (item_total >= self.preferred_lower_boundry && item_total <= self.preferred_upper_boundry)
        ...
        return self.preferred_default_amount
      end
    end
  end
end
